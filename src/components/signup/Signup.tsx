...
const Signup = ({inputType, dispatch, isShowPassword}: Props) => {
  ...
  return (
    <motion.div 
        ...
        <HeaderText>We are <span className='text-primary-500'>excited</span> about you joining us!</HeaderText>
        <form action="" className='min-w-[250px] mx-auto flex flex-col justify-center align-center mt-10'>
            ...
            <button 
                ...
                className="primary-btn w-full mt-5">Sign Up</button>
        </form>
